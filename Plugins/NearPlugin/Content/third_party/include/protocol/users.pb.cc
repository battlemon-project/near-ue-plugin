...
const ::_pbi::DescriptorTable descriptor_table_users_2eproto = {
    false, false, 70, descriptor_table_protodef_users_2eproto,
    "users.proto",
    &descriptor_table_users_2eproto_once, nullptr, 0, 0,
    schemas, file_default_instances, TableStruct_users_2eproto::offsets,
    nullptr, file_level_enum_descriptors_users_2eproto,
